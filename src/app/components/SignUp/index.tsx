    ...
    <div className='w-full px-4 md:px-12'>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center bg-white font-sans">
        <div className="w-full md:w-1/2 mb-8 md:mb-0">
          <img src="./media/image.png" alt="image" className="w-full h-auto" />
        </div>
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="mt-9 text-center">
            ...
            <span className="text-[20px] text-primary mr-2">Already have an account? </span>
            <a href="#" className="font-medium text-foreground hover:text-secondary">Login</a>
          </div>
        </div>
      </div>
    </div>
